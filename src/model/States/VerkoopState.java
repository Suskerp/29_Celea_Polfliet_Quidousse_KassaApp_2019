...
public interface VerkoopState {
    ...
    default void verwijder(int id){throw new StateException("Onmoglijk om nog een item te verwijderen");}
    ...
    default void scanItem(int id){throw new StateException("Onmogelijk om nu nog items te scannen");}
}
